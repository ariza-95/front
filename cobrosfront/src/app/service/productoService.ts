...
export class ProductoService {
  ...
  productoURL = 'http://localhost:8180/crud-0.0.1-SNAPSHOT/producto/';
  constructor(private httpClient: HttpClient) { }

  public lista(): Observable<Producto[]> {
    return this.httpClient.get<Producto[]>(this.productoURL + 'lista');
  }
  public listaContains(id: string): Observable<Producto[]> {
    return this.httpClient.get<Producto[]>(this.productoURL + `listaContains/${id}`);
  }
